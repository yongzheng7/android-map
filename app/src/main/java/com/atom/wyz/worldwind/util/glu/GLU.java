...
*/
package com.atom.wyz.worldwind.util.glu;


import com.atom.wyz.worldwind.util.glu.error.SimpleError;
import com.atom.wyz.worldwind.util.glu.tessellator.GLUtessellatorImpl;
...
public class GLU 
{
  public static String gluErrorString(int errorCode) {
    return SimpleError.gluErrorString(errorCode);
  }
