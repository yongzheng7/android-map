...
open class SurfaceImage : AbstractRenderable,
    ...
    override fun doRender(rc: RenderContext) {
        ...
        val drawable = DrawableSurfaceTexture.obtain(rc.getDrawablePool(
            DrawableSurfaceTexture::class.java))
