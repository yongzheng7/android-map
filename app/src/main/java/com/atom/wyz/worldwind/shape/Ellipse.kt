...
class Ellipse : AbstractShape {
    companion object {
        ...
        protected fun assembleElements(intervals: Int): BufferObject? {
            ...
            val offset: Int = computeIndexOffset(intervals)
    ...
    protected fun mustAssembleGeometry(rc: RenderContext): Boolean {
        ...
        val sanitizedIntervals = sanitizeIntervals(calculatedIntervals) // 得到偶数
    ...
    protected fun assembleGeometry(rc: RenderContext) {
        ...
        // 确定脊椎点数
        val spineCount: Int =
            computeNumberSpinePoints(activeIntervals) // activeIntervals must be even
        ...
        for (i in 0 until activeIntervals) {
            ...
            val loc: Location = center.greatCircleLocation(azimuth, arcRadius, scratchPosition)
