...
open class AtmosphereAndGroundProgram() : GpuProgram() {
    ...
    override fun initProgram(dc: DrawContext) {
        ...
        val invWavelength: Vec3 = Vec3(
                ...
                1 / Math.pow(0.475, 4.0)) // 475 nm for blue
    ...
    open fun loadGlobe(globe: Globe) {
        val gr: Double = globe.equatorialRadius
        val ar = gr + altitude
