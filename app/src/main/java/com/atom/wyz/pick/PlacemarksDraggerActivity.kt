...
import com.atom.map.renderable.shape.Movable
...
class PlacemarksDraggerActivity : BasicWorldWindActivity() {
    ...
    class CustomWorldWindowController(context: Context, wwd: WorldWindow?) :
        ...
        init {
            preNavGestureDetector = GestureDetector(context,
                PickDragListener(wwd!!)
            )
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wwd.worldWindowController = (CustomWorldWindowController(
            applicationContext,
            wwd
        ))
        ...
        smallImage.putUserProperty(
            Dragger::class.java,
            SimpleDragger()
        )
        bigImage.putUserProperty(
            Dragger::class.java,
            SimpleDragger()
        )
